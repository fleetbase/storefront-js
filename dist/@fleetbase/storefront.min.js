!(function (t, e) {
  ...
  function Y(t) {
    ...
    return (Y = function (t) {
      ...
      function r() {
        return H(t, arguments, q(this).constructor);
      }
      return (
  ...
  var Q = Array.isArray,
    B = void 0 === arguments ? void 0 : arguments,
    G = function (t, e, n) {
      var r =
        arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : [];
      if (Q(t))
        if (r.length <= 6e4) t.splice.apply(t, [e, n].concat(W(r)));
        else {
          t.splice(e, n);
          for (var i = 0; i < r.length; i += 6e4) {
            var a = r.slice(i, i + 6e4);
            t.splice.apply(t, [e + i, 0].concat(W(a)));
          }
        }
      else K(arr) && t.replace(e, n, r);
    },
    X = function (t) {
      return t;
    },
    ...
    J = function (t, e) {
      return Q(t) ? t[e] : K(t) ? t.objectAt(e) : null;
    },
    Z = function (t, e) {
      return 2 === B.length
        ? function (n) {
    ...
    at = (function (t) {
      ...
      function n() {
        ...
        return (
          ...
          L(
            Q(arguments[0])
              ? e.call.apply(e, [this].concat(W(arguments[0])))
        ...
        U(n, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var r = e; r >= 0; r--) if (J(this, r) === t) return r;
              return -1;
            },
          },
          {
            key: "includes",
            value: function (t, e) {
              return -1 !== rt(this, t, e, !0);
            },
          },
          {
            key: "findBy",
            value: function () {
              return tt(this, Z.apply(void 0, arguments));
            },
          },
          {
            key: "findIndexBy",
            value: function () {
              return V(this, Z.apply(void 0, arguments));
            },
          },
          {
            key: "isEvery",
            value: function () {
              return nt(this, Z.apply(void 0, arguments));
            },
          },
          {
            key: "isAny",
            value: function () {
              return et(this, Z.apply(void 0, arguments));
            },
          },
          {
            key: "invoke",
    ...
    ut = function (t) {
      return ot(t) || ("string" == typeof t && !1 === /\S/.test(t));
    };
  function st(t) {
  ...
  var ct = function () {
      ...
      return !(
        ...
        ("object" !==
          E(null === (t = process) || void 0 === t ? void 0 : t.env) &&
          -1 ===
    ...
    ht = function () {
      ...
      return ct()
        ? jt("adapter", "NodeAdapter", t)
        : jt("adapter", "BrowserAdapter", t);
    },
    lt = Array.isArray;
  !(function () {
    function t(e) {
    ...
    U(t, [
      ...
      },
      {
        ...
        value: function () {
          var t =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return (this.attributes = D(D({}, this.attributes), t)), this;
        },
      },
      {
        key: "setAttribute",
  ...
  var dt = (function () {
      function t() {
        ...
        P(this, t), (this.type = "Point"), (this.coordinates = [n, e]);
      }
      return (
        U(
          t,
          [
            ...
            },
            {
              ...
              value: function () {
                return "("
                  .concat(this.latitude, ", ")
                  .concat(this.longitude, ")");
              },
            },
          ],
          [
    ...
    ft = function (t, e) {
      var n = t();
      return Array.isArray(n) || "object" === E(n) ? vt(n, e) : null;
    },
    vt = function t(e, n) {
      var r,
        i = e,
        ...
        u = "function" === a,
        s = Array.isArray(e),
        c = "string" === E(n) && n.includes(".") ? n.split(".") : [n];
      if (s || o) {
        for (var h = 0; h < c.length; h++) {
          ...
          if (i) {
            if (
              "object" === E((r = i = i[c[h]])) &&
              !ot(null == r ? void 0 : r.attributes) &&
              "object" === E(null == r ? void 0 : r.attributes) &&
              void 0 !== c[h + 1]
            ) {
    ...
    gt = function (t, e, n) {
      var r = t,
        i = "object" === E(t),
        a = Array.isArray(t),
        o = "string" === E(e) && e.includes(".") ? e.split(".") : [e],
        u = o.length;
      if (a || i) {
        for (var s = 0; s < u - 1; s++)
          r[o[s]] || (r[o[s]] = {}), (r = r[o[s]]);
        ...
        var e =
          ...
          n =
            arguments.length > 1 && void 0 !== arguments[1]
              ? arguments[1]
              : null;
        P(this, t), (this.actions = e), (this.bind = n);
      }
      return (
        U(t, [
          {
            ...
            value: function () {
              var t =
                ...
                e = t || this.bind;
              if (!e) return this;
              if (null != this && this.actions && "object" === E(this.actions))
                for (var n in this.actions) {
                  var r = this.actions[n];
                  gt(e, n, "function" == typeof r ? r.bind(e) : r);
                }
              return this;
            },
          },
        ...
        U(t, [
          {
            ...
            value: function (t) {
              ...
              return (
                (this.adapter = t),
                (this.store = new $t(this.resource, t, {
              ...
              var e,
                n =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : null;
              if (null === n && "object" === E(t)) return this.setAttributes(t);
              var r =
                ...
                void 0 !== e
                  ...
                  : null;
              return (
                gt(this.attributes, t, n),
                gt(this.dirtyAttributes, t, r),
                Q(null == this ? void 0 : this.changes[t]) ||
                  (this.changes[t] = []),
                this.changes[t].push({
                  property: t,
                  previousValue: r,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                !(null == this || !this.attributes) && t in this.attributes
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return Q(t)
                ? this.hasAttribute(t) &&
                    t.every(function (t) {
                      return !ot(e.getAttribute(t));
                    })
                : this.hasAttribute(t) && !ot(this.getAttribute(t));
            },
          },
          {
            key: "getAttributes",
            value: function (t) {
              ...
              if (!Q(t)) throw new Error("No attribute properties provided!");
              for (var n = 0; n < t.length; n++) {
                ...
                if ("string" == typeof a) {
                  ...
                  "object" !==
                    E(
                      null === (r = o) || void 0 === r ? void 0 : r.attributes,
                    ) ||
                    Q(
                      null === (i = o) || void 0 === i ? void 0 : i.attributes,
                    ) ||
                    (o = o.attributes),
                    (e[a] = o);
                }
              ...
              var t,
                ...
                n =
                  ...
                  void 0 !== t
                    ? t
                    : {};
              return (this.attributes = D(D({}, n), e)), this.attributes;
            },
          },
          {
            key: "syncAttributes",
    ...
    wt = (function (t) {
      ...
      function n() {
        ...
        return P(this, n), e.call(this, t, r, "order", D({ actions: mt }, i));
      }
      return (
        U(n, [
          {
    ...
    bt = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "payload", i);
      }
      return (
        U(n, [
  ...
  !(function (t) {
    ...
    function n() {
      ...
      return P(this, n), e.call(this, t, r, "entity", i);
    }
  })();
  var kt = (function (t) {
    j(n, yt);
    ...
    function n() {
      var t =
        ...
        r = arguments.length > 1 ? arguments[1] : void 0,
        i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
      return P(this, n), e.call(this, t, r, "place", i);
    }
    return (
      U(
        n,
        [
          {
            ...
            get: function () {
              var t;
              return null === (t = this.getAttribute("location", new dt())) ||
                void 0 === t
                ? void 0
                : t.coordinates[1];
            },
          ...
          },
          {
            ...
            value: function (t) {
              return (
                st(t) && this.setAttribute("owner", t.id),
  ...
  !(function (t) {
    ...
    function n() {
      var t =
        ...
        r = arguments.length > 1 ? arguments[1] : void 0,
        i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
      return P(this, n), e.call(this, t, r, "waypoint", i);
    }
  })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "tracking-status", i);
      }
    })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "vehicle", i);
      }
    })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "driver", i);
      }
    })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "vendor", i);
      }
    })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "contact", i);
      }
    })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "zone", i);
      }
    })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "service-area", i);
      }
    })(),
    (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "service-rate", i);
      }
    })();
  var Tt = (function (t) {
      j(n, yt);
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return P(this, n), e.call(this, t, r, "service-quote", i);
      }
      return (
        U(n, [
            ...
            value: function () {
              var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : {};
              return (this.headers = D(D({}, this.headers), t)), this;
            },
          },
          {
            key: "parseJSON",
              ...
              var e =
                ...
                n =
                  arguments.length > 2 && void 0 !== arguments[2]
                    ? arguments[2]
                    : {},
                r = ut(e) ? "" : new URLSearchParams(e).toString();
              return this.request(
    ...
    At = (function (t) {
      ...
      function n(t) {
        ...
        return (
          P(this, n),
          ((i = e.call(this, t)).axios = r.default.create({
        ...
        U(n, [
          {
            ...
            value: function () {
              ...
              return (
                (this.axios.defaults.headers.common = D(D({}, e), t)), this
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              if (t.response) {
                ...
                if (Q(e.errors)) throw new Error(e.errors[0]);
    ...
    Et = (function () {
      function t(e) {
        ...
        P(this, t),
          ...
          M(this, "idSuffix", new RegExp("(_ids|_id)$", "g")),
          M(this, "underbar", new RegExp("_", "g")),
          M(this, "spaceOrUnderbar", new RegExp("[ _]", "g")),
          M(this, "uppercase", new RegExp("([A-Z])", "g")),
          M(this, "underbarPrefix", new RegExp("^_")),
          (this.str = e),
          (this.chain = n);
      }
      return (
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  (t = t || this.str),
                  (t =
                    this.underscore(this.demodulize(t)) +
                    (e ? "" : "_") +
                    "id"),
                  (this.str = t),
                  !0 === this.chain ? this : t
          ...
          [
            {
              ...
              value: function () {
                ...
                return (
                  e.shift(),
                  "function" == typeof n[r] ? n[r].apply(n, W(e)) : null
                );
              },
            },
          ],
    ...
    Rt = { Place: kt, Payload: bt, Order: wt },
    Ut = { BrowserAdapter: Ct, NodeAdapter: At, EmberJsAdapter: Dt },
    Mt = (function () {
      function t() {
        return (
          P(this, t),
        ...
        U(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (!this[n][e])
                throw new Error(
                  "No ".concat(Ot(t), " named ").concat(e, " to resolve"),
                );
              return H(this[n][e], W(r));
            },
          },
        ]),
        t
    ...
    jt = function () {
      return H(Mt, Array.prototype.slice.call(arguments));
    },
    qt = function (t) {
      var e =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
      if (((t.actions = Q(e) ? e : [e]), !Q(e)))
        return e instanceof pt && e.extend(t), t;
      for (var n = 0; n < e.length; n++) {
        var r = e[n];
        t.extendActions(r);
      }
      ...
      return (
        U(t, [
          ...
          },
          {
            key: "serialize",
            value: function (t) {
              return jt("resource", Pt(this.resource), t, this.adapter);
            },
          },
          {
            key: "afterFetch",
  ...
  !(function () {
    function t(e) {
      ...
      if (!ct() && e.toLowerCase().startsWith("$"))
        throw new Error(
          "Secret key provided. You must use a public key with Fleetbase Javascript SDK!",
        );
      (this.adapter = n.adapter || ht(this.options)),
        (this.orders = new $t("order", this.adapter).extendActions(mt)),
        (this.entities = new $t("entity", this.adapter)),
        (this.places = new $t("place", this.adapter)),
        (this.drivers = new $t("driver", this.adapter)),
        (this.vehicles = new $t("vehicle", this.adapter)),
        (this.vendors = new $t("vendor", this.adapter)),
        (this.contacts = new $t("contact", this.adapter));
    }
    U(
      t,
      [
      ...
      [
        {
          key: "newInstance",
          value: function () {
            return H(t, Array.prototype.slice.call(arguments));
          },
        },
      ],
    );
  ...
  var Nt = (function (t) {
        ...
        c(n, [
          {
            ...
            value: function (t) {
              ...
              return (
                (this.adapter = t),
                (this.store = new Cr(this.resource, t, {
                  onAfterFetch: this.syncAttributes.bind(this),
                  actions:
                    null === (e = this.options) || void 0 === e
                      ? void 0
    ...
    Yt = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "review", i);
      }
      return (
        c(n, [
    ...
    Lt = function () {
      var t =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return ct()
        ? xr("adapter", "NodeAdapter", t)
        : xr("adapter", "BrowserAdapter", t);
    },
    Ft = function () {
      var t =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
  ...
  function _t() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
      e =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "USD",
      n =
        arguments.length > 2 && void 0 !== arguments[2]
          ? arguments[2]
          : "symbol";
  ...
  var Wt = function (t) {
    ...
    It = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "product", i);
      }
      return (
        c(n, [
          {
    ...
    Qt = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "category", i);
      }
      return (
        c(n, [
          {
    ...
    Bt = new pt({
      login: function (t) {
        ...
        return this.adapter
          .post("customers/login", a({ identity: t, password: e }, n))
      ...
      verifyCode: function (t, e) {
        var n =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return this.adapter
          .post("customers/verify-code", a({ identity: t, code: e }, n))
          .then(this.afterFetch.bind(this));
      },
      ...
      create: function (t, e) {
        var n =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return this.adapter
          .post("customers", a({ identity: t, code: e }, n))
          .then(this.afterFetch.bind(this));
      },
      retrieve: function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return (
          u(this, n), e.call(this, t, r, "customer", a({ actions: Bt }, i))
        );
      }
      return (
        c(n, [
    ...
    Jt = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "cart", a({ actions: Kt }, i));
      }
      return (
        c(n, [
          {
              ...
              var e =
                ...
                r =
                  arguments.length > 3 && void 0 !== arguments[3]
                    ...
                    : {};
              return (
                t instanceof It && (t = t.id),
                this.store.add(this.id, t, e, n, r)
              );
            },
          },
          {
  ...
  function ie(t) {
    if ((Vt(1, arguments), !re(t) && "number" != typeof t)) return !1;
    var e = te(t);
  ...
  var ce = {
    ...
    de = {
      date: se({ formats: ce, defaultWidth: "full" }),
      time: se({ formats: he, defaultWidth: "full" }),
      dateTime: se({ formats: le, defaultWidth: "full" }),
    },
    fe = de,
    ve = {
  ...
  var me = {
    ...
    Ae = {
      ordinalNumber: Ce,
      era: ye({ values: me, defaultWidth: "wide" }),
      quarter: ye({
        values: we,
        defaultWidth: "wide",
      ...
      month: ye({ values: be, defaultWidth: "wide" }),
      day: ye({ values: ke, defaultWidth: "wide" }),
      dayPeriod: ye({
        values: Te,
        defaultWidth: "wide",
        formattingValues: xe,
  ...
  var Xe = {
      y: function (t, e) {
        var n = t.getUTCFullYear(),
          r = n > 0 ? n : 1 - n;
        return Ge("yy" === e ? r % 100 : r, e.length);
      },
      M: function (t, e) {
        var n = t.getUTCMonth();
        return "M" === e ? String(n + 1) : Ge(n + 1, 2);
      },
      d: function (t, e) {
        return Ge(t.getUTCDate(), e.length);
      },
      a: function (t, e) {
      ...
      h: function (t, e) {
        return Ge(t.getUTCHours() % 12 || 12, e.length);
      },
      H: function (t, e) {
        return Ge(t.getUTCHours(), e.length);
      },
      m: function (t, e) {
        return Ge(t.getUTCMinutes(), e.length);
      },
      s: function (t, e) {
        return Ge(t.getUTCSeconds(), e.length);
      },
      S: function (t, e) {
        var n = e.length,
          r = t.getUTCMilliseconds();
        return Ge(Math.floor(r * Math.pow(10, n - 3)), e.length);
      },
    },
    Ke = Xe,
    Je = 864e5;
  ...
  function cn(t, e) {
    Vt(1, arguments);
    var n = te(t),
      r = an(n, e).getTime() - un(n, e).getTime();
  ...
  var hn = {
    ...
    ln = {
      ...
      R: function (t, e) {
        return Ge(tn(t), e.length);
      },
      u: function (t, e) {
        return Ge(t.getUTCFullYear(), e.length);
      },
      Q: function (t, e, n) {
      ...
      k: function (t, e, n) {
        ...
        return (
          0 === r && (r = 24),
          "ko" === e ? n.ordinalNumber(r, { unit: "hour" }) : Ge(r, e.length)
        );
      },
      m: function (t, e, n) {
        return "mo" === e
      ...
      t: function (t, e, n, r) {
        ...
        return Ge(Math.floor(i.getTime() / 1e3), e.length);
      },
      T: function (t, e, n, r) {
        return Ge((r._originalDate || t).getTime(), e.length);
      },
    };
  function dn(t, e) {
    var n = t > 0 ? "-" : "+",
    ...
    var o = e || "";
    return n + String(i) + o + Ge(a, 2);
  }
  function fn(t, e) {
    return t % 60 == 0
      ? (t > 0 ? "-" : "+") + Ge(Math.abs(t) / 60, 2)
      : vn(t, e);
  }
  function vn(t, e) {
    var n = e || "",
      r = t > 0 ? "-" : "+",
      i = Math.abs(t);
    return r + Ge(Math.floor(i / 60), 2) + n + Ge(i % 60, 2);
  }
  var gn = ln;
  function pn(t, e) {
    switch (t) {
  ...
  function mn(t, e) {
    ...
    return n.replace("{{date}}", pn(i, e)).replace("{{time}}", yn(a, e));
  }
  var wn = { p: yn, P: mn },
    bn = wn,
    kn = ["D", "DD"],
  ...
  var Dn = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,
    En = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,
    Sn = /^'([^]*?)'?$/,
    On = /''/g,
    Pn = /[a-zA-Z]/;
  function Rn(t, e, n) {
    ...
    var d = te(t);
    if (!ie(d)) throw new RangeError("Invalid time value");
    var f = ne(d),
      v = Be(d, f),
      g = {
      ...
      p = r
        ...
        .map(function (t) {
          var e = t[0];
          return "p" === e || "P" === e ? (0, bn[e])(t, a.formatLong, g) : t;
        })
        .join("")
        .match(Dn)
        .map(function (n) {
          ...
          if (o)
            return (
              !i.useAdditionalWeekYearTokens && Cn(n) && An(n, e, t),
              !i.useAdditionalDayOfYearTokens && xn(n) && An(n, e, t),
              o(v, n, a.localize, g)
            );
          if (r.match(Pn))
            throw new RangeError(
  ...
  function Un(t) {
    return t.match(Sn)[1].replace(On, "'");
  }
  function Mn(t, e) {
    if (null == t)
      throw new TypeError(
  ...
  function zn(t, e) {
    ...
    return {
      value: r * (i * Hn + a * Yn + o * Ln),
      rest: e.slice(n[0].length),
    };
  }
  function In(t, e) {
    return Wn(Fn.anyDigitsSigned, t, e);
  }
  function Qn(t, e, n) {
    switch (t) {
      case 1:
        return Wn(Fn.singleDigit, e, n);
      case 2:
        return Wn(Fn.twoDigits, e, n);
      case 3:
        return Wn(Fn.threeDigits, e, n);
      case 4:
        return Wn(Fn.fourDigits, e, n);
      default:
  ...
  function Bn(t, e, n) {
    switch (t) {
      case 1:
        return Wn(Fn.singleDigitSigned, e, n);
      case 2:
        return Wn(Fn.twoDigitsSigned, e, n);
      case 3:
        return Wn(Fn.threeDigitsSigned, e, n);
      case 4:
        return Wn(Fn.fourDigitsSigned, e, n);
      default:
        return Wn(new RegExp("^-?\\d{1," + t + "}"), e, n);
    }
  }
  ...
  var Vn = {
      ...
      R: {
        priority: 130,
        parse: function (t, e, n, r) {
          return Bn("R" === e ? 4 : e.length, t);
        },
        set: function (t, e, n, r) {
          var i = new Date(0);
          return i.setUTCFullYear(n, 0, 4), i.setUTCHours(0, 0, 0, 0), Ve(i);
        },
        incompatibleTokens: [
          "G",
          "y",
      ...
      d: {
        ...
        validate: function (t, e, n) {
          var r = Zn(t.getUTCFullYear()),
            i = t.getUTCMonth();
          return r ? e >= 1 && e <= Jn[i] : e >= 1 && e <= Kn[i];
        },
        set: function (t, e, n, r) {
      ...
      E: {
        ...
        set: function (t, e, n, r) {
          return (t = jn(t, n, r)).setUTCHours(0, 0, 0, 0), t;
        },
      ...
      a: {
        ...
        set: function (t, e, n, r) {
          return t.setUTCHours(Gn(n), 0, 0, 0), t;
        },
      ...
      S: {
        priority: 30,
        parse: function (t, e, n, r) {
          return Qn(e.length, t, function (t) {
      ...
      X: {
        ...
        parse: function (t, e, n, r) {
          switch (e) {
            case "X":
              return zn(_n.basicOptionalMinutes, t);
            case "XX":
              return zn(_n.basic, t);
            case "XXXX":
              return zn(_n.basicOptionalSeconds, t);
            case "XXXXX":
              return zn(_n.extendedOptionalSeconds, t);
            default:
              return zn(_n.extended, t);
          }
        },
        set: function (t, e, n, r) {
  ...
  function sr(t, e, n, r) {
    ...
    if (!(f >= 0 && f <= 6))
      throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");
    if ("" === a) return "" === i ? te(n) : new Date(NaN);
    var v,
      g = { firstWeekContainsDate: h, weekStartsOn: f, locale: u },
      p = [{ priority: er, subPriority: -1, set: cr, index: 0 }],
      y = a
        .match(rr)
        .map(function (t) {
          var e = t[0];
          return "p" === e || "P" === e ? (0, bn[e])(t, u.formatLong, g) : t;
        })
        .join("")
        .match(nr),
      m = [];
    for (v = 0; v < y.length; v++) {
      var w = y[v];
      !o.useAdditionalWeekYearTokens && Cn(w) && An(w, a, t),
        !o.useAdditionalDayOfYearTokens && xn(w) && An(w, a, t);
      var b = w[0],
        k = tr[b];
      if (k) {
    ...
    if (i.length > 0 && or.test(i)) return new Date(NaN);
    var E = p
        .map(function (t) {
          return t.priority;
        })
    ...
    for (v = 0; v < E.length; v++) {
      var R = E[v];
      if (R.validate && !R.validate(O, R.value, g)) return new Date(NaN);
      var U = R.set(O, P, R.value, g);
      U[0] ? ((O = U[0]), Mn(P, U[1])) : (O = U);
    }
    return O;
  }
  function cr(t, e) {
  ...
  function hr(t) {
    return t.match(ir)[1].replace(ar, "'");
  }
  var lr = (function (t) {
      l(n, t);
      var e = m(n);
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "store-hour", i);
      }
      return (
        c(n, [
          {
          ...
          },
          {
            ...
            get: function () {
              ...
              var t = this.getAttribute("start"),
                e = 3 === t.split(":").length;
              return sr(t, e ? "HH:mm:ss" : "HH:mm", new Date());
            },
          },
          {
            key: "endDateInstance",
          ...
          },
          {
            ...
            get: function () {
              return ie(this.startDateInstance) && ie(this.endDateInstance)
                ? ""
                    .concat(Rn(this.startDateInstance, "p"), " - ")
                    .concat(Rn(this.endDateInstance, "p"))
    ...
    dr = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "store-location", i);
      }
      return (
        c(n, [
          {
    ...
    fr = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "payment-gateway", i);
      }
      return (
        c(n, [
          {
    ...
    vr = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "store", i);
      }
      return (
        c(n, [
          {
              ...
              var t = this,
                e =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : {};
              return this.adapter
                .get("locations", a({ store: this.id }, e))
                .then(function (e) {
                  return new at(
                    e.map(function (e) {
                      return (
                        e.place && (e.place = new kt(e.place)),
                        new dr(e, t.adapter)
                      );
                    }),
                  );
    ...
    gr = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "network", i);
      }
      return (
        c(n, [
          {
    ...
    yr = (function (t) {
      ...
      function n() {
        ...
        return (
          u(this, n),
          r instanceof xt
            ? y(t, (t = e.call(this, {}, r, "service-quote", a)))
            : e.call(this, r, i, "service-quote", a)
        );
      }
      return (
        c(
            ...
            },
            {
              ...
              get: function () {
                var t = this.getAttributes(["amount", "currency"]),
                  e = t.amount,
                  n = t.currency;
                return zt(e) || zt(n) ? null : _t(e / 100, n);
              },
            },
            {
              key: "fromCart",
    ...
    mr = new pt({
      ...
      initialize: function (t, e, n, r) {
        ...
        return (
          ...
          st(e) && (e = e.id),
          st(n) && (n = n.id),
          st(r) && (r = r.getAttribute("code")),
          this.adapter.get(
            "".concat(this.namespace, "/before"),
            a(
              a({}, i),
              {},
              { customer: t, cart: e, serviceQuote: n, gateway: r },
            ),
            o,
          )
        );
    ...
    wr = (function (t) {
      ...
      function n() {
        var t =
          ...
          i =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return u(this, n), e.call(this, t, r, "checkout", i);
      }
      return (
        c(n, [
          {
    ...
    kr = { BrowserAdapter: Ct, NodeAdapter: At },
    Tr = (function () {
      function t() {
        return (
          u(this, t),
    ...
    xr = function () {
      return g(Tr, Array.prototype.slice.call(arguments));
    },
    Cr = (function (t) {
      l(n, t);
      var e = m(n);
      ...
      return (
        c(n, [
          ...
          },
          {
            key: "serialize",
            value: function (t) {
              return xr("resource", Pt(this.resource), t, this.adapter);
            },
          },
        ]),
        n
    ...
    Ar = (function () {
      function t(e) {
        ...
        (this.adapter = n.adapter || Lt(this.options)),
          (this.products = new Cr("product", this.adapter)),
          (this.categories = new Cr("category", this.adapter)),
          (this.reviews = new Cr("review", this.adapter).extendActions(Ht)),
          (this.customers = new Cr("customer", this.adapter).extendActions(Bt)),
          (this.cart = new Cr("cart", this.adapter).extendActions(Kt)),
          (this.checkout = new Cr("checkout", this.adapter).extendActions(mr));
      }
      return (
        c(
          t,
          ...
          [
            {
              key: "newInstance",
              value: function () {
                return g(t, Array.prototype.slice.call(arguments));
              },
            },
          ],
        ),
